...
function main() {
  ...
  var camPosLocation = gl.getUniformLocation(program, "u_camPos");
  ...
  webglLessonsUI.setupSlider("#xCamPos", {value: fudgeFactor, slide: updateCamPos, min: -1, max: 1, step: 0.001, precision: 3 });
  ...
  function updateCamPos(event, ui) {
    camPos[0] = ui.value;
    drawScene();
  }
